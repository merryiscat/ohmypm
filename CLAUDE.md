...
## 작업 구조 (kickoff-workspaces v0.2.0)
...
- 원본 체크아웃(main) = 머지·커밋·푸시만. **업무 요청을 받으면 직접 하지 말고 `ohmypm:dispatch` 스킬로 pl→pl2에 넘긴다**(예외: 문서 한 줄·머지·질문 답). 반복 운영 업무는 첫 회만 스펙, 이후는 pl2가 워커 재배정
