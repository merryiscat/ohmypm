...
**Q. pl·pl2 세션은 언제 비우나요?**
pl(아스트라)은 작업 하나가 끝날 때마다, pl2(페이블)는 그 작업이 합쳐진 뒤에 `/clear`. 절차가 자동으로 보내지만 손으로 해도 됩니다. 규칙 파일을 고쳤으면 둘 다 바로 비웁니다. 기억은 세션이 아니라 스펙·검토서 파일에 있으니 잃는 게 없습니다.
