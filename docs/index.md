...
- [protocol.md](protocol.md) — main/pl/work의 설계 합의·실행·검증·로컬 통합 절차
- [roles.md](roles.md) — 역할과 변경 경계
- [workflow.json](workflow.json) — 역할별 에이전트·모델 설정
- [workflow-guide.md](workflow-guide.md) — 실행 도구 입력·명령·중단 복구·환경 회수
