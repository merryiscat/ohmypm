<!-- kickoff-workspaces v0.3.0 — 원본은 ohmypm 플러그인. 여기서 고치지 말고 플러그인을 고친 뒤 "구조 업데이트하자" -->
...
워커 브랜치를 읽고 완료 기준마다 통과/실패를 판정해 스펙의 "검증" 절에 적는다(pl2가 스펙 파일을 쓰는 유일한 경우). **M 차선은 기준별 한 줄, 재조회·재실행은 차단 기준에만** — 전부 재검증하면 검증이 워커만큼 걸린다(실측 5분). **고치지 않는다** —
