<!-- kickoff-workspaces v0.3.1 — 원본은 ohmypm 플러그인. 여기서 고치지 말고 플러그인을 고친 뒤 "구조 업데이트하자" -->
...
검증은 **산출물을 읽어서** 한다 — 스크립트로 재현하지 않는다. 1분 넘게 도는 명령은 쓰지 않는다(실측: 재현 명령 하나가 30분 멈춰 바퀴 전체가 섰다). **고치지 않는다** —
